import {
  ...
  require_subYears,
  require_toDate
} from "./chunk-Z4U43SR6.js";
import "./chunk-5L4KA5R2.js";
import {
  require_react_dom
...
var require_dist = __commonJS({
  "node_modules/react-datepicker/dist/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    var clsx = require_clsx();
    ...
    var addQuarters = require_addQuarters();
    var addSeconds = require_addSeconds();
    var addWeeks = require_addWeeks();
    var addYears = require_addYears();
    var differenceInCalendarDays = require_differenceInCalendarDays();
    var differenceInCalendarMonths = require_differenceInCalendarMonths();
    var differenceInCalendarQuarters = require_differenceInCalendarQuarters();
    var differenceInCalendarYears = require_differenceInCalendarYears();
    ...
    var getISOWeek = require_getISOWeek();
    var getMinutes = require_getMinutes();
    var getMonth = require_getMonth();
    var getQuarter = require_getQuarter();
    var getSeconds = require_getSeconds();
    var getTime = require_getTime();
    var getYear = require_getYear();
    var isAfter = require_isAfter();
    var isBefore = require_isBefore();
    var isDate = require_isDate();
    var isEqual$1 = require_isEqual();
    var isSameDay$1 = require_isSameDay();
    var isSameMonth$1 = require_isSameMonth();
    var isSameQuarter$1 = require_isSameQuarter();
    var isSameYear$1 = require_isSameYear();
    var isValid$1 = require_isValid();
    ...
    var setQuarter = require_setQuarter();
    ...
    var startOfQuarter = require_startOfQuarter();
    var startOfWeek = require_startOfWeek();
    var startOfYear = require_startOfYear();
    var subDays = require_subDays();
    var subMonths = require_subMonths();
    var subQuarters = require_subQuarters();
    var subWeeks = require_subWeeks();
    var subYears = require_subYears();
    var toDate = require_toDate();
    var react = (init_floating_ui_react_esm(), __toCommonJS(floating_ui_react_esm_exports));
    var ReactDOM = require_react_dom();
    function _interopDefaultCompat(e) {
      return e && typeof e === "object" && "default" in e ? e : { default: e };
    }
    var React__default = _interopDefaultCompat(React);
    var ReactDOM__default = _interopDefaultCompat(ReactDOM);
    ...
    var CalendarContainer = function(_a2) {
      ...
      return React__default.default.createElement("div", { className, role: "dialog", "aria-label": ariaLabel, "aria-modal": "true" }, children);
    };
    ...
    var ClickOutsideWrapper = function(_a2) {
      ...
      return React__default.default.createElement("div", { className, style, ref: function(node) {
    ...
    function parseDate(value, dateFormat, locale, strictParsing, minDate) {
      ...
      if (Array.isArray(dateFormat)) {
        dateFormat.forEach(function(df) {
          var tryParseDate = parse.parse(value, df, /* @__PURE__ */ new Date(), {
            locale: localeObject,
      ...
      parsedDate = parse.parse(value, dateFormat, /* @__PURE__ */ new Date(), {
        locale: localeObject,
        useAdditionalWeekYearTokens: true,
        useAdditionalDayOfYearTokens: true
      });
      if (strictParsing) {
        ...
        if (value.length > 0) {
          parsedDate = parse.parse(value, format_1.slice(0, value.length), /* @__PURE__ */ new Date(), {
            useAdditionalWeekYearTokens: true,
            useAdditionalDayOfYearTokens: true
          });
        }
    ...
    function isValid(date, minDate) {
      return isValid$1.isValid(date) && !isBefore.isBefore(date, minDate !== null && minDate !== void 0 ? minDate : /* @__PURE__ */ new Date("1/1/1800"));
    }
    ...
    function isDayInRange(day, startDate, endDate) {
      ...
      try {
        valid = isWithinInterval.isWithinInterval(day, { start, end });
      } catch (err) {
        valid = false;
      }
      return valid;
    ...
    function isDayDisabled(day, _a2) {
      ...
      return isOutOfBounds(day, { minDate, maxDate }) || excludeDates && excludeDates.some(function(excludeDate) {
        ...
        return isWithinInterval.isWithinInterval(day, { start, end });
    ...
    function isMonthDisabled(month, _a2) {
      ...
      return isOutOfBounds(month, {
        minDate: minDate ? startOfMonth.startOfMonth(minDate) : void 0,
        maxDate: maxDate ? endOfMonth.endOfMonth(maxDate) : void 0
    ...
    function isYearDisabled(year, _a2) {
      ...
      return isOutOfBounds(date, {
        minDate: minDate ? startOfYear.startOfYear(minDate) : void 0,
        maxDate: maxDate ? endOfYear.endOfYear(maxDate) : void 0
      }) || (excludeDates === null || excludeDates === void 0 ? void 0 : excludeDates.some(function(excludeDate) {
    ...
    function isOutOfBounds(day, _a2) {
      ...
      return (_b = minDate && differenceInCalendarDays.differenceInCalendarDays(day, minDate) < 0 || maxDate && differenceInCalendarDays.differenceInCalendarDays(day, maxDate) > 0) !== null && _b !== void 0 ? _b : false;
    }
    ...
    function isTimeInDisabledRange(time, _a2) {
      ...
      var min2 = newDate();
      min2 = setHours.setHours(min2, getHours.getHours(minTime));
      min2 = setMinutes.setMinutes(min2, getMinutes.getMinutes(minTime));
      min2 = setSeconds.setSeconds(min2, getSeconds.getSeconds(minTime));
      var max2 = newDate();
      max2 = setHours.setHours(max2, getHours.getHours(maxTime));
      max2 = setMinutes.setMinutes(max2, getMinutes.getMinutes(maxTime));
      max2 = setSeconds.setSeconds(max2, getSeconds.getSeconds(maxTime));
      var valid;
      try {
        valid = !isWithinInterval.isWithinInterval(baseTime, { start: min2, end: max2 });
      } catch (err) {
        valid = false;
      }
      return valid;
    ...
    function timesToInjectAfter(startOfDay2, currentTime, currentMultiplier, intervals, injectedTimes) {
      ...
      for (var i = 0; i < l; i++) {
        ...
        var nextTime = addMinutes.addMinutes(startOfDay2, (currentMultiplier + 1) * intervals);
        if (isAfter.isAfter(injectedTime, currentTime) && isBefore.isBefore(injectedTime, nextTime) && injectedTimeValue != void 0) {
    ...
    function startOfMinute(d) {
      ...
      return toDate.toDate(d.getTime() - seconds * 1e3 - milliseconds);
    }
      ...
      function(_super) {
        ...
        function Day2() {
          ...
          _this.isAfterMonth = function() {
            return _this.props.month !== void 0 && (_this.props.month + 1) % 12 === getMonth.getMonth(_this.props.day);
          };
          _this.isBeforeMonth = function() {
            return _this.props.month !== void 0 && (getMonth.getMonth(_this.props.day) + 1) % 12 === _this.props.month;
          };
        ...
        function Week2() {
          ...
          _this.renderDays = function() {
            ...
            if (_this.props.showWeekNumber) {
              ...
              days.push(React__default.default.createElement(WeekNumber, _assign({ key: "W" }, Week2.defaultProps, _this.props, { weekNumber, date: startOfWeek2, onClick: onClickAction })));
            }
            return days.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset) {
              var day = addDays.addDays(startOfWeek2, offset);
              return React__default.default.createElement(Day, _assign({}, Week2.defaultProps, _this.props, { ariaLabelPrefixWhenEnabled: _this.props.chooseDayAriaLabelPrefix, ariaLabelPrefixWhenDisabled: _this.props.disabledDayAriaLabelPrefix, key: day.valueOf(), day, onClick: _this.handleDayClick.bind(_this, day), onMouseEnter: _this.handleDayMouseEnter.bind(_this, day) }));
            }));
          };
      ...
      function(_super) {
        ...
        function Month2() {
          ...
          _this.isWeekInMonth = function(startOfWeek2) {
            ...
            var endOfWeek2 = addDays.addDays(startOfWeek2, 6);
          ...
          _this.renderWeeks = function() {
            ...
            while (true) {
              weeks.push(React__default.default.createElement(Week, _assign({}, _this.props, { ariaLabelPrefix: _this.props.weekAriaLabelPrefix, key: i, day: currentWeekStart, month: getMonth.getMonth(_this.props.day), onDayClick: _this.handleDayClick, onDayMouseEnter: _this.handleDayMouseEnter, selected, preSelection, showWeekNumber: _this.props.showWeekNumbers })));
            ...
            var calculateNewDateAndMonth = function(eventKey2, date, month2) {
              ...
              switch (eventKey2) {
                case KeyType.ArrowRight:
                  newCalculatedDate2 = addMonths.addMonths(date, MONTH_NAVIGATION_HORIZONTAL_OFFSET);
                  newCalculatedMonth2 = month2 === 11 ? 0 : month2 + MONTH_NAVIGATION_HORIZONTAL_OFFSET;
                  break;
                case KeyType.ArrowLeft:
                  newCalculatedDate2 = subMonths.subMonths(date, MONTH_NAVIGATION_HORIZONTAL_OFFSET);
                  newCalculatedMonth2 = month2 === 0 ? 11 : month2 - MONTH_NAVIGATION_HORIZONTAL_OFFSET;
                  break;
                case KeyType.ArrowUp:
                  newCalculatedDate2 = subMonths.subMonths(date, verticalOffset);
                ...
                case KeyType.ArrowDown:
                  newCalculatedDate2 = addMonths.addMonths(date, verticalOffset);
          ...
          _this.getMonthClassNames = function(m) {
            ...
            var _monthClassName = monthClassName ? monthClassName(setMonth.setMonth(day, m)) : void 0;
          ...
          _this.getQuarterClassNames = function(q) {
            ...
            var isDisabled = (minDate || maxDate || excludeDates || includeDates || filterDate) && isQuarterDisabled(setQuarter.setQuarter(day, q), _this.props);
          ...
          _this.renderMonths = function() {
            ...
            return monthColumns === null || monthColumns === void 0 ? void 0 : monthColumns.map(function(month, i) {
              return React__default.default.createElement("div", { className: "react-datepicker__month-wrapper", key: i }, month.map(function(m, j) {
                return React__default.default.createElement("div", { ref: _this.MONTH_REFS[m], key: j, onClick: function(event) {
          ...
          _this.renderQuarters = function() {
            ...
            return React__default.default.createElement("div", { className: "react-datepicker__quarter-wrapper" }, quarters.map(function(q, j) {
              return React__default.default.createElement("div", { key: j, ref: _this.QUARTER_REFS[j], role: "option", onClick: function(event) {
        ...
        function MonthDropdown2() {
          ...
          _this.renderSelectOptions = function(monthNames) {
            return monthNames.map(function(m, i) {
              return React__default.default.createElement("option", { key: m, value: i }, m);
            });
          };
          _this.renderSelectMode = function(monthNames) {
            return React__default.default.createElement("select", { value: _this.props.month, className: "react-datepicker__month-select", onChange: function(e) {
          ...
          _this.renderDropdown = function(monthNames) {
            return React__default.default.createElement(MonthDropdownOptions, _assign({ key: "dropdown" }, _this.props, { monthNames, onChange: _this.onChange, onCancel: _this.toggleDropdown }));
          };
      ...
      function(_super) {
        ...
        function MonthYearDropdown2() {
          ...
          _this.renderSelectMode = function() {
            return React__default.default.createElement("select", { value: getTime.getTime(getStartOfMonth(_this.props.date)), className: "react-datepicker__month-year-select", onChange: _this.onSelectChange }, _this.renderSelectOptions());
          };
          ...
          _this.renderDropdown = function() {
            return React__default.default.createElement(MonthYearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
          };
      ...
      function(_super) {
        ...
        function Time2() {
          ...
          _this.liClasses = function(time) {
            ...
            if (_this.props.injectTimes && (getHours.getHours(time) * 3600 + getMinutes.getMinutes(time) * 60 + getSeconds.getSeconds(time)) % (((_a2 = _this.props.intervals) !== null && _a2 !== void 0 ? _a2 : Time2.defaultProps.intervals) * 60) !== 0) {
      ...
      function(_super) {
        ...
        function Year2(props) {
          ...
          _this.getYearClassNames = function(y) {
            ...
            return clsx.clsx("react-datepicker__year-text", "react-datepicker__year-".concat(y), date ? yearClassName === null || yearClassName === void 0 ? void 0 : yearClassName(setYear.setYear(date, y)) : void 0, {
              "react-datepicker__year-text--selected": selected ? y === getYear.getYear(selected) : void 0,
        ...
        Year2.prototype.render = function() {
          ...
          var _loop_1 = function(y2) {
            yearsList.push(React__default.default.createElement("div", { ref: this_1.YEAR_REFS[y2 - startPeriod], onClick: function(event) {
          ...
          return React__default.default.createElement(
            ...
            React__default.default.createElement("div", { className: "react-datepicker__year-wrapper", onMouseLeave: !this.props.usePointerEvent ? this.props.clearSelectingDate : void 0, onPointerLeave: this.props.usePointerEvent ? this.props.clearSelectingDate : void 0 }, yearsList)
          );
        };
        return Year2;
      }(React.Component)
        ...
        function YearDropdownOptions2(props) {
          ...
          _this.renderOptions = function() {
            ...
            if (!maxYear || !_this.state.yearsList.find(function(year) {
              ...
              options.unshift(React__default.default.createElement(
                "div",
            ...
            if (!minYear || !_this.state.yearsList.find(function(year) {
              ...
              options.push(React__default.default.createElement(
                "div",
    ...
    var YearDropdown = (
      ...
      function(_super) {
        ...
        function YearDropdown2() {
          ...
          _this.renderSelectMode = function() {
            return React__default.default.createElement("select", { value: _this.props.year, className: "react-datepicker__year-select", onChange: _this.onSelectChange }, _this.renderSelectOptions());
          };
          _this.renderReadView = function(visible) {
            return React__default.default.createElement(
              "div",
          ...
          _this.renderDropdown = function() {
            return React__default.default.createElement(YearDropdownOptions, _assign({ key: "dropdown" }, _this.props, { onChange: _this.onChange, onCancel: _this.toggleDropdown }));
          };
          _this.renderScrollMode = function() {
            var dropdownVisible = _this.state.dropdownVisible;
            var result = [_this.renderReadView(!dropdownVisible)];
        ...
        function Calendar2(props) {
          ...
          _this.decreaseYear = function() {
            _this.setState(function(_a2) {
              ...
              var date = _a2.date;
              return {
                date: subYears.subYears(date, _this.props.showYearPicker ? (_b = _this.props.yearItemNumber) !== null && _b !== void 0 ? _b : Calendar2.defaultProps.yearItemNumber : 1)
              };
            }, function() {
              return _this.handleYearChange(_this.state.date);
            });
          ...
          _this.increaseYear = function() {
            _this.setState(function(_a2) {
              ...
              var date = _a2.date;
              return {
                date: addYears.addYears(date, _this.props.showYearPicker ? (_b = _this.props.yearItemNumber) !== null && _b !== void 0 ? _b : Calendar2.defaultProps.yearItemNumber : 1)
              };
            }, function() {
              return _this.handleYearChange(_this.state.date);
            });
          ...
          _this.renderYearDropdown = function(overrideHide) {
            ...
            return React__default.default.createElement(YearDropdown, _assign({}, Calendar2.defaultProps, _this.props, { date: _this.state.date, onChange: _this.changeYear, year: getYear.getYear(_this.state.date) }));
          };
          _this.renderMonthDropdown = function(overrideHide) {
            ...
            return React__default.default.createElement(MonthDropdown, _assign({}, Calendar2.defaultProps, _this.props, { month: getMonth.getMonth(_this.state.date), onChange: _this.changeMonth }));
          };
          _this.renderMonthYearDropdown = function(overrideHide) {
            ...
            return React__default.default.createElement(MonthYearDropdown, _assign({}, Calendar2.defaultProps, _this.props, { date: _this.state.date, onChange: _this.changeMonthYear }));
          };
          ...
          _this.renderMonths = function() {
            ...
            for (var i = 0; i < monthsShown; ++i) {
              ...
              monthList.push(React__default.default.createElement(
                "div",
          ...
          _this.renderYears = function() {
            ...
            if (_this.props.showYearPicker) {
              return React__default.default.createElement(
                ...
                React__default.default.createElement(Year, _assign({}, Calendar2.defaultProps, _this.props, { selectingDate: _this.state.selectingDate, date: _this.state.date, onDayClick: _this.handleDayClick, clearSelectingDate: _this.clearSelectingDate, onYearMouseEnter: _this.handleYearMouseEnter, onYearMouseLeave: _this.handleYearMouseLeave }))
              );
            }
            return;
          };
          _this.renderTimeSection = function() {
            if (_this.props.showTimeSelect && (_this.state.monthContainer || _this.props.showTimeSelectOnly)) {
              return React__default.default.createElement(Time, _assign({}, Calendar2.defaultProps, _this.props, { onChange: _this.props.onTimeChange, format: _this.props.timeFormat, intervals: _this.props.timeIntervals, monthRef: _this.state.monthContainer }));
            }
            return;
          };
          _this.renderInputTimeSection = function() {
            ...
            if (_this.props.showTimeInput) {
              return React__default.default.createElement(InputTime, _assign({}, Calendar2.defaultProps, _this.props, { date: time, timeString, onChange: _this.props.onTimeChange }));
            }
            return;
          };
    ...
    var CalendarIcon = function(_a2) {
      ...
      if (typeof icon === "string") {
        return React__default.default.createElement("i", { className: "".concat(defaultClass, " ").concat(icon, " ").concat(className), "aria-hidden": "true", onClick });
      }
      ...
      function(_super) {
        ...
        PopperComponent2.prototype.render = function() {
          ...
          if (portalId && !hidePopper) {
            popper = React__default.default.createElement(Portal, { portalId, portalHost }, popper);
          }
      ...
      function(_super) {
        ...
        function DatePicker2(props) {
          ...
          _this.calcInitialState = function() {
            ...
            var minDate = getEffectiveMinDate(_this.props);
            var maxDate = getEffectiveMaxDate(_this.props);
            var boundedPreSelection = minDate && isBefore.isBefore(defaultPreSelection, getStartOfDay(minDate)) ? minDate : maxDate && isAfter.isAfter(defaultPreSelection, getEndOfDay(maxDate)) ? maxDate : defaultPreSelection;
            return {
          ...
          _this.onDayKeyDown = function(event) {
            ...
            var calculateNewDate = function(eventKey2, date) {
              ...
              switch (eventKey2) {
                case KeyType.ArrowRight:
                  newCalculatedDate = showWeekPicker ? addWeeks.addWeeks(date, 1) : addDays.addDays(date, 1);
                  break;
                case KeyType.ArrowLeft:
                  newCalculatedDate = showWeekPicker ? subWeeks.subWeeks(date, 1) : subDays.subDays(date, 1);
                  break;
                case KeyType.ArrowUp:
                ...
                case KeyType.ArrowDown:
                  ...
                  break;
                case KeyType.PageUp:
                  newCalculatedDate = isShiftKeyActive ? subYears.subYears(date, 1) : subMonths.subMonths(date, 1);
                  break;
                case KeyType.PageDown:
                  newCalculatedDate = isShiftKeyActive ? addYears.addYears(date, 1) : addMonths.addMonths(date, 1);
                  break;
                case KeyType.Home:
          ...
          _this.renderCalendar = function() {
            ...
            return React__default.default.createElement(Calendar, _assign({ showMonthYearDropdown: void 0, ref: function(elem) {
              _this.calendar = elem;
          ...
          _this.renderDateInput = function() {
            var _a2, _b;
            var _c;
            var className = clsx.clsx(_this.props.className, (_a2 = {}, _a2[outsideClickIgnoreClass] = _this.state.open, _a2));
            ...
            return React.cloneElement(customInput, (_b = {}, _b[customInputRef] = function(input) {
              _this.input = input;
          ...
          _this.renderClearButton = function() {
            ...
            if (isClearable && (selected != null || startDate != null || endDate != null || (selectedDates === null || selectedDates === void 0 ? void 0 : selectedDates.length))) {
              return React__default.default.createElement("button", { type: "button", className: clsx.clsx("react-datepicker__close-icon", clearButtonClassName, { "react-datepicker__close-icon--disabled": disabled }), disabled, "aria-label": ariaLabelClose, onClick: _this.onClearClick, title: clearButtonTitle, tabIndex: -1 });
            } else {
              return null;
            }
          };
        ...
        DatePicker2.prototype.renderInputContainer = function() {
          ...
          return React__default.default.createElement(
            ...
            showIcon && React__default.default.createElement(CalendarIcon, _assign({ icon, className: clsx.clsx(calendarIconClassName, !calendarIconClassName && calendarIconClassname, open && "react-datepicker-ignore-onclickoutside") }, toggleCalendarOnIconClick ? {
        ...
        DatePicker2.prototype.render = function() {
          ...
          if (this.props.withPortal) {
            var portalContainer = this.state.open ? React__default.default.createElement(
              TabLoop,
              { enableTabLoop: this.props.enableTabLoop },
              React__default.default.createElement("div", { className: "react-datepicker__portal", tabIndex: -1, onKeyDown: this.onPortalKeyDown }, calendar)
            ) : null;
...
react-datepicker/dist/index.js:
  ...
  *)
*/
//# sourceMappingURL=react-datepicker_dist.js.map
