...
export default function MainCard({
  ...
  if (linkTo) {
    return (
      <Link
        ...
        to={linkTo}
      >
        <div className="h-full w-full bg-muted hover:bg-white rounded-lg flex flex-col content-center items-center justify-items-center justify-center">
          {header && (
  ...
  return (
    ...
    >
      <div className="h-full w-full bg-[var(--muted-foreground)] hover:bg-white rounded-lg flex flex-col content-center items-center justify-items-center justify-center">
        {header && (
