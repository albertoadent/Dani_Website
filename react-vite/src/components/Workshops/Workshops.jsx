...
export default function Workshops() {
  ...
  return (
    <div className="mt-32 top-1">
      <h1 className="fixed top-[10%] left-[50%] transform -translate-x-1/2 -translate-y-1/2 justify-center bg-card text-popover border-t-0 border-r-2 border-b-2 border-l-2 border-accent rounded-lg text-xl font-bold p-2 z-0">
        Workshops
      </h1>
